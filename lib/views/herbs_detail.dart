...
class HerbsDetail extends StatefulWidget {
  const HerbsDetail({super.key});

  @override
  State<HerbsDetail> createState() => _HerbsDetailState();
}

class _HerbsDetailState extends State<HerbsDetail> {
  @override
  Widget build(BuildContext context) {
    final provider = Provider.of<HerbsProvider>(context).herbs;
    return Scaffold(
