...
import 'package:slick_garden/views/add_veg.dart';
import 'package:slick_garden/views/detail.dart';
...
class _VegetablePageState extends State<VegetablePage> {
  ...
  Widget build(BuildContext context) {
    final provider = Provider.of<VegetableProvider>(context);
    return MyDrawer(
          ...
          floatingActionButton: FloatingActionButton(
            onPressed: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: ((context) => const AddVegetables())));
            },
